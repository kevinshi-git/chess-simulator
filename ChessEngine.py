...
class GameState:
    ...
    def makeMove(self, move): #function that executes moves
        ...
        # pawn promotion, can only promote to Queen. 
        #to do: try to make it so it can promote to any piece
    ...
    def undoMove(self): #redo last move
    ...
    def updateCastleRights(self, move): #updates castling information after a move
    ...
    def getValidMoves(self): #returns list of possible moves while taking to acount checks/pins
    ...
    def inCheck(self): #determins if current player is in check
        if self.white_to_move:
            return self.squareUnderAttack(self.white_king_location[0], self.white_king_location[1])
        else:
            return self.squareUnderAttack(self.black_king_location[0], self.black_king_location[1])

    def squareUnderAttack(self, row, col): #checks if enemy can attack square
    ...
    def getAllPossibleMoves(self):# gets all possible moves without considering checks/pins
        moves = []
